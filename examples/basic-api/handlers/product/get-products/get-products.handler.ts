...
export class GetProductsHandler implements Handler<GetProductsRequest, GetProductsResponse[]> {

    handle(_request: GetProductsRequest): Promise<GetProductsResponse[]> {
...
verticalSlice.RegisterHandler<GetProductsRequest, GetProductsResponse[]>(new GetProductsRequest, getProductsHandler);